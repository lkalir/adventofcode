...
{
    const auto dut = AocSolution<1, 2015>();
...
{
    const auto dut = AocSolution<2, 2015>();
    const auto data = dut.inputs();
...
{
    const auto dut = AocSolution<3, 2015>();
    const auto data = dut.inputs();
...
{
    const auto dut = AocSolution<4, 2015>();
    const auto data = dut.inputs();
...
{
    const auto dut = AocSolution<5, 2015>();
    const auto data = dut.inputs();
...
{
    const auto dut = AocSolution<1, 2019>();
    const auto data = dut.inputs();
